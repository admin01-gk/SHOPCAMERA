(function() {
    tinymce.PluginManager.add('engagebay_lp_builder_button', function( editor, url ) {
        editor.addButton( 'engagebay_lp_builder_button', {
            text: 'Engagebay Forms',
            icon: false,
            onclick: function() {
            jQuery.ajax({
                url: "?engagebay_lp_builder_list_form=1",
            }).done(function(data ) {
                ...
                editor.windowManager.open( {
                    ...
                    onsubmit: function( e ) {
                        editor.insertContent( '[engagebay_lp_builderform id="' + e.data.form+ '"]');
                    }
                });
                }
            });
