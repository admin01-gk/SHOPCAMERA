            ...
            if ($status == '' && $remind_later == '') {
                ?>
                    <div class="notice notice-success is-dismissible">
                        <p><?php _e('Thank you for using <b>Elementor Addon Elements</b>! How is your Experience with us ?', 'wpv-fv'); ?></p>

                        <p>
                            <a class="eae-notice-link" style="padding: 5px;" target="_blank" href="https://wordpress.org/support/plugin/addon-elements-for-elementor-page-builder/reviews/#new-post" class="button button-primary"><span class="dashicons dashicons-heart" style="text-decoration : none; margin : 0px 3px;"></span><?php _e('Ok, you deserve it!', 'wts-eae'); ?></a>
                            <a class="eae-notice-link" style="padding: 5px;" href="<?php echo add_query_arg('remind_later', 'later'); ?>"><span class="dashicons dashicons-schedule" style="text-decoration : none; margin : 0px 3px;"></span><?php _e('May Be Later', 'wts-eae'); ?></a>
                            <a class="eae-notice-link" style="padding: 5px;" href="<?php echo add_query_arg('review_done', 'done'); ?>"><span class="dashicons dashicons-smiley" style="text-decoration : none; margin : 0px 3px;"></span><?php _e('Already Done', 'wts-eae'); ?></a>
                        </p>
                    </div>
        <?php
            }
